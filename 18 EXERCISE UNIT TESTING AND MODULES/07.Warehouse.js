...
console.log(test);
console.log(test.addProduct("Food","ribs",10))
console.log(test.addProduct("Food","ara",10))
console.log(test.addProduct("Food","bara",10))
console.log(test.scrapeAProduct("ribs", 5))
console.log(test.occupiedCapacity());
console.log(test.revision());
console.log(test.orderProducts("Food"));