function solve() {
    ...
    // regexa прави масив - първо с целия хванат текст, после на всеки следващ елемент слага кепчър групите. Тук е (.+) - всичко+
...
//let northP = document.innerHTML("<p>hello</p>") // няма да мине през джъдж, затова:
